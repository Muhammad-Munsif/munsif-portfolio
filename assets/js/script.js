...
const GOOGLE_SCRIPT_URL ="https://script.google.com/macros/s/AKfycbwAe-1hNGQkd7NFLoZCgmtAPKElNVqP9oXY6yAAgcv3r59fbGmNuVLZFDsNgikqIUaTQg/exec"
// Notification system
...
document.addEventListener('click', (e) => {
    if (!logo.contains(e.target) && !infoPanel.contains(e.target) && isInfoPanelOpen) {
...
document.querySelectorAll('.section, .about-text, .skills-container, .contact-info, .contact-form').forEach(el => {
    observer.observe(el);
});
